...
DEFAULT_ARECORD_BUFFER_TIME_US = _env_int("FPGAFFT_ARECORD_BUFFER_TIME_US", 80000)
DEFAULT_ARECORD_PERIOD_TIME_US = _env_int("FPGAFFT_ARECORD_PERIOD_TIME_US", 10000)
DEFAULT_ARECORD_PIPE_SIZE_BYTES = _env_int("FPGAFFT_ARECORD_PIPE_SIZE_BYTES", 1 << 16)
DEFAULT_CAPTURE_BACKEND = (os.environ.get("FPGAFFT_CAPTURE_BACKEND") or CAPTURE_BACKEND_AUTO).strip().lower()
# Default to one FFT window per ALSA read so live viewers and trigger-based
# tools reflect wall-clock time more closely. Users can still override this via
# FPGAFFT_NATIVE_CAPTURE_READ_FRAMES if they prefer larger batching.
DEFAULT_NATIVE_CAPTURE_READ_FRAMES = _env_int("FPGAFFT_NATIVE_CAPTURE_READ_FRAMES", 512)
DEFAULT_NATIVE_CAPTURE_PERIOD_FRAMES = _env_int("FPGAFFT_NATIVE_CAPTURE_PERIOD_FRAMES", 512)
DEFAULT_NATIVE_CAPTURE_BUFFER_FRAMES = _env_int("FPGAFFT_NATIVE_CAPTURE_BUFFER_FRAMES", 2048)
DEFAULT_NATIVE_CAPTURE_QUEUE_CHUNKS = _env_int("FPGAFFT_NATIVE_CAPTURE_QUEUE_CHUNKS", 32)
DEFAULT_NATIVE_CAPTURE_PIPE_SIZE_BYTES = _env_int("FPGAFFT_NATIVE_CAPTURE_PIPE_SIZE_BYTES", 1 << 16)
