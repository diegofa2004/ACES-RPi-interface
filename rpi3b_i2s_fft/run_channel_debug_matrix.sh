...
usage() {
  cat <<'EOF'
Run a small matrix of passive channel-debug captures for the FPGA I2S FFT stream.
...
Options:
  ...
  -r, --rate HZ                Sample rate (default: 48000)
      ...
      --seconds S              Capture time per scenario (default: 12)
      ...
      --extra-tag-shifts LIST  Extra relaxed probe shifts, space or comma separated
                               (default: 29)
      --chunk-pairs N          Raw stereo pairs summarized per JSONL chunk (default: 1024)
